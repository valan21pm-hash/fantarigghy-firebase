                              ...
                              (pName, idx) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <span className="text-[8px] font-bold uppercase tracking-wider opacity-60 text-indigo-400 shrink-0">
                ...
                <div className="flex gap-2">
                  {authenticatedTeamId && (
                    <button
                      ...
                      onClick={handleSaveLineup}
                      disabled={submitting || (lockStatus.isLineupLocked && !isAdminMode)}
                      className="bg-emerald-600 hover:bg-emerald-500 disabled:bg-indigo-900 border border-emerald-600 disabled:text-indigo-400 text-white font-black uppercase tracking-wider text-[10.5px] px-3.5 py-2.5 rounded-xl shadow-lg active:scale-95 transition-transform shrink-0"
                    >
                      {submitting ? "..." : "Salva Formazione"}
                    </button>
                  )}
                  <button
                    type="submit"
                    disabled={submitting || checkIsSubmitLocked()}
                    className="bg-yellow-400 hover:bg-yellow-350 disabled:bg-indigo-800 disabled:text-indigo-400 text-indigo-950 font-black uppercase tracking-wider text-[10.5px] px-5 py-2.5 rounded-xl shadow-lg active:scale-95 transition-transform shrink-0 disabled:border disabled:border-indigo-700"
                  >
                                ...
                                >
                                  <div className="flex justify-between items-start">
                                    <div className="min-w-0 pr-2 text-left">
                                      ...
                                      <p className="text-[9.5px] font-semibold text-indigo-600 font-mono mt-1">
                           ...
                           <div key={mIdx} className="bg-white border border-indigo-100 rounded-lg p-2 text-[9px] flexflex-col gap-1">
                             ...
                             <div className="flex flex-wrap gap-1.5">
                               {mb.giocatoriKpi.map((kpi: any, kIdx: number) => {
                                 ...
                                 return (
                                   <div key={kIdx} className={`px-1.5 py-0.5 rounded border ${isOut ? "bg-red-50 text-red-700 border-red-200 opacity-70" : "bg-indigo-50 text-indigo-800 border-indigo-200 font-bold"}`}>
                ...
                >
                  ...
                  {(kpi.stato === "Panchina" || kpi.stato === "Sostituito" || kpi.stato === "Assente") && kpi.unassignedBonuses && kpi.unassignedBonuses.length > 0 && (
                    <div className="mt-3 pt-2.5 border-t border-red-100 flex flex-col gap-1">
                      <span className="text-[9px] font-black text-black uppercase tracking-wide flex items-center gap-1.5">
